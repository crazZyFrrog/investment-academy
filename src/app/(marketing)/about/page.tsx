          ...
          <article className="space-y-8 rounded-[var(--radius-2xl)] border border-border/80 bg-surface/95 px-6 py-8 shadow-sm backdrop-blur-sm sm:px-10 sm:py-10">
            <div className="space-y-4">
              ...
              <p className="text-body text-text-secondary">
                ...
                горизонте. Контент версионируется в git, прогресс сохраняется
                локально и работает офлайн.
              </p>
              <p className="text-body text-text-secondary">
                Сейчас доступен гостевой режим без аккаунта. Вход и синхронизация
                между устройствами появятся в версии 1.0.
              </p>
            </div>
